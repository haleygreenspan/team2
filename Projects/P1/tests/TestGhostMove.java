...
public class TestGhostMove extends TestCase {
	...
	public void testGhostMove() throws FileNotFoundException{
		...
		assertEquals(true, ghost1.move());
		Ghost ghost2 = frame.addGhost(new Location(-1, -1), "name2", Color.red); //Creates a red ghost named "name" at location x,y
		assertEquals(false, ghost2.move());
		Ghost ghost3 = frame.addGhost(new Location(40, 40), "name3", Color.red); //Creates a red ghost named "name" at location x,y
		assertEquals(false, ghost3.move());
